...
@mcp.tool()
async def get_series_observations(series_id: str, start_date: str = None, end_date: str = None) -> str:
...
@mcp.tool()
async def search_series(query: str, search_type: str = "full_text", limit: int = 10) -> str:
