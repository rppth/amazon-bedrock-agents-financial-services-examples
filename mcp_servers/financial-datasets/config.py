...
class Config:
    ...
    def _load_env_vars(self):
        ...
        if env_file.exists():
            ...
            if example_env.exists():
                print(f"No .env file found. Please copy .env.example to .env and add your API key.")
    ...
    def _validate_config(self):
        ...
        if not self.financial_datasets_api_key:
            print("Warning: FINANCIAL_DATASETS_API_KEY is not set. Some functionality may be limited.")
        ...
        try:
            ...
            if result.returncode != 0:
                ...
                print("You may need to modify the server_command in config.py if using a different path.")
