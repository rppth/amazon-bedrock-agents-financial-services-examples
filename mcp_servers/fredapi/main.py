...
""",
        ...
        ).invoke(input_text="Can you look up the latest unemployment rate (UNRATE) and inflation data (CPIAUCSL) and explain what these indicators tell us about the current economic situation?")
