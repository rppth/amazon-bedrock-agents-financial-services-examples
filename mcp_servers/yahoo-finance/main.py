...
async def main():
    ...
    yahoo_finance_client = await MCPStdio.create(server_params=config.get_server_params())
...
""",
        ...
        ).invoke(input_text="Can you provide a financial analysis of Apple (AAPL) by looking at their current stock price and recent performance? Include both raw data and your analysis.")
