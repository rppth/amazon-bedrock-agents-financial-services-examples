...
async def main():
    ...
    financial_datasets_client = await MCPStdio.create(server_params=config.get_server_params())
...
""",
        ...
        ).invoke(input_text="Can you provide a financial analysis of Apple (AAPL) by looking at their income statements and current stock price? Include both raw data and your analysis.")
