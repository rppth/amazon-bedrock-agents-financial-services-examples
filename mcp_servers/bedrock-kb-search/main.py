...
1. QueryKnowledgeBases(query, knowledge_base_id, reranking=True, reranking_model_name="AMAZON", data_source_ids=None)
   ...
   - knowledge_base_id: The ID of the knowledge base to query (must be from resource://knowledgebases)
...
""",
        ...
        ).invoke(input_text="Can you tell how Insurance Company is doing rating, my KD ID is EHEJINO7RZ")
