...
""",
        ...
        ).invoke(input_text=f"I'm a Python beginner. Can you show me how to work with this Python REPL? Maybe start with a simple example and then something more advanced with data visualization.")
