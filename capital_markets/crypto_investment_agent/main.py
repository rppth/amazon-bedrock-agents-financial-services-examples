...
async def main():
    ...
    financial_datasets_client = await MCPStdio.create(server_params=config.financial_datasets_params)
    fredapi_client = await MCPStdio.create(server_params=config.fredapi_params)
    perplexity_search_client = await MCPStdio.create(server_params=config.perplexity_search_params)
...
""",
            ...
            action_groups=[financial_datasets_action_group, fredapi_action_group, perplexity_search_action_group, code_interpreter_action_group],
        ).invoke(
